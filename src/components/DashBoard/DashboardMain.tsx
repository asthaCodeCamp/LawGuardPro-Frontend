...
const DashboardMain: React.FC = () => {
  ...
  let fullName = session?.data?.user?.firstName +" "+ session?.data?.user?.lastName;
  console.log(fullName)
  const [caseData, setCaseData] = useState<CaseData>({ totalCount: 0, data: [] });
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`http://54.203.205.46:5140/api/case/list?pageNumber=${page}&pageSize=${perPage}`, {
          headers: {
    ...
    <div className="flex w-full">
        ...
        <div>
          <div className="flex gap-[24px] ml-[32px] mr-[32px] mt-[32px]">
            ...
            <div className="gap-[8px]">
              ...
              <p className="text-[32px] mb-[8px]">Your profile is 50% complete.</p>
              <p className="text-[16px] text-gray-600">You still need to provide a few more details.</p>
            </div>
          </div>
      ...
      <div className="ml-[32px] flex flex-col w-[30%]">
        <div>
          ...
          <p className="text-[16px] font-[400] text-gray-600">You have no pending quotes.</p>
        </div>
