...
const SingleQuote: React.FC<SingleQuoteProps> = ({ quote }) => {
  const{Quote_No,value,total_value,status,payment_method} = quote
  return (
    <div className="w-full border-b p-6">
      <div className="mb-6">
        <h1 className="text-lg font-semibold text-[#6D6D6D]">Quote No: {Quote_No}</h1>
      </div>
      <div className="flex justify-between">
        <div className="border rounded-l-md w-full pl-6 py-4">
          <h1 className="text-[14px] font-semibold text-[#6D6D6D] mb-2">VALUE ( EX VAT )</h1>
          <h1 className="text-lg font-semibold text-[#191919]">{value}</h1>
        </div>
        <div className="border w-full pl-6 py-4 ">
          <h1 className="text-[14px] font-semibold text-[#6D6D6D] mb-2">TOTAL VALUE</h1>
          <h1 className="text-lg font-semibold text-[#191919]">{total_value}</h1>
        </div>
        <div className="border w-full pl-6 py-4">
          <h1 className="text-[14px] font-semibold text-[#6D6D6D] mb-2">DATE CREATED</h1>
          <h1 className="text-lg font-semibold text-[#191919]">$350.50</h1>
        </div>
        <div className="border w-full pl-6 py-4">
          <h1 className="text-[14px] font-semibold text-[#6D6D6D] mb-2">STATUS</h1>
          <h1 className="text-lg font-semibold text-[#191919]">{status}</h1>
        </div>
        <div className="border w-full rounded-r-md pl-6 py-4">
          <h1 className="text-[14px] font-semibold text-[#6D6D6D] mb-2">PAYMENT METHOD</h1>
          <h1 className="text-lg font-semibold text-[#191919]">{payment_method}</h1>
        </div>
      </div>
