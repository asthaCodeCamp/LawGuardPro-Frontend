...
const signup: React.FC = () => {
    ...
    const { register, watch, handleSubmit, reset, setValue, getValues, setError, formState: { errors } } = useForm<FormData>({
        mode: 'onChange'
    });
        ...
        <div className='flex justify-center items-center mt-[116px] mb-[206px]'>
            <div className="w-[700px]">
                ...
                <div className="justify-center items-center text-center flex mt-[32px]">
                    ...
                    <Link className="text-[#6B0F99]" href={"/login"}>Log in</Link>
                </div>
            </div>
        </div>
    );
